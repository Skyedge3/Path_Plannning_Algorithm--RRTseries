% filepath: /f:/机械臂/小论文/小论文代码/RRTseries_dev/lib/planRRTStar.m
classdef planRRTStar < planRRT
    ...
    methods
        function obj = planRRTStar(stateSpace, stateValidator)
            ...
            % 设置目标检测函数，仅对状态的前三个维度（位置）进行比较
            obj.GoalReachedFcn = @(planner, goalState, currentState) ...
                (norm(goalState(1:3) - currentState(1:3)) < 5);  % 5为距离阈值，可根据需要调整
        end
